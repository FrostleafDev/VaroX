...
public final class VaroX extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Commands Initialize
        getCommand("varo").setExecutor(new VaroCommand(config, lang, fileManager, statesManager, this));

        // Listener Initialize
        Bukkit.getPluginManager().registerEvents(new JoinLeaveListener(statesManager, this), this);
